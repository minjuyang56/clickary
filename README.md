...
![프로젝트 관리](docs/screenshots/02_project_preview.png)
...
![캡처 다이얼로그](docs/screenshots/03_capture_dialog.png)
...
![텍스트 입력](docs/screenshots/04_capture_text_input.png)
...
![다운로드 팝업](docs/screenshots/06_overlay_popup.png)
